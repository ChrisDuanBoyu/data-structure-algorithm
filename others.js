...
var leastInterval = function(tasks, n) {
    ...
    let maxCount = taskCount.pop()
 
    let otherMaxCount = 1;
    while(taskCount[taskCount.length - 1] == maxCount){
        otherMaxCount ++;
        taskCount.pop()
    }
    ...
    const res = (maxCount - 1) * (n + 1) + otherMaxCount
 ...
 function getTaskCount(tasks){
     ...
     console.log(Object.values(taskMap).sort((a,b)=>a-b))
     return Object.values(taskMap).sort()
 }
